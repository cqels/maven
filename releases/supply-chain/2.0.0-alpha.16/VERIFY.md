...
```bash
curl -fsSLO "https://raw.githubusercontent.com/cqels/CQELS4J/81bc5b39125fd1018b1110dd40f98e395fabcbcd/cosign.pub"
...
done < <(find org/cqels -path "*/2.0.0-alpha.16/*" -name '*.jar' 2>/dev/null)
