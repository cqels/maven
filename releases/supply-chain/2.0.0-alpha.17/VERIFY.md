# Verifying org.cqels 2.0.0-alpha.17
...
```bash
REL=org/cqels/cqels-engine/2.0.0-alpha.17/cqels-engine-2.0.0-alpha.17.jar
...
done < <(find org/cqels -path "*/2.0.0-alpha.17/*" -name '*.jar' 2>/dev/null)
